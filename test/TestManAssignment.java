...
public class TestManAssignment {
    ...
    public void testManTwoWeekAssignment() throws Exception {
        ...
        assertEquals(SoftwareHouse.getProjects().get(0).getAssignmentList().get(0).getBookedTime(),82);
    }
    ...
    public void manTwoPeopleToAssignment() throws Exception{
        ...
        assertEquals(SoftwareHouse.getProjects().get(0).getAssignmentList().get(0).getBookedTime(),120);
